				...
				<div class="card card-custom gutter-b cont-item" style="position:relative;z-index:9;">
					<div class="card-body p-20">
						<div class="text-center mb-10">
							...
							<p style="text-dark-50" style="width:60%;">Atur ulang kata sandimu menggunakan tautan yang akan <br> kami kirimkan ke email-mu</p>
						</div>
						...
						<a class="btn btn-warning btn-lg btn-block font-weight-bolder pl-7 pr-7 text-center" style="text-decoration:none;cursor:pointer;color:#23479F;background-color:#F3C729;border-color:#F3C729;"><span>Kirim</span></a>
	                    <div class="form-group d-flex mt-5 flex-wrap justify-content-between align-items-center mt-3">
							<div class="checkbox-inline">
                                <a href="<?php echo base_url('login');?>"><i class="icon-md mt-2 la la-arrow-left"></i> Kembali </a>
							</div>
							<a href="<?php echo base_url('register')?>" class="text-muted text-hover-primary">Daftar akun</a>
						</div>
                    </div>
				</div>
            </div>
